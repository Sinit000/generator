...
body  {
  ...
  width: 100%;
    background: linear-gradient(to top,rgba(0,0,0,0.5)50%,rgba(0,0,0,0.5)50%),url("../public/img/users/rpr_background.png");
    background-position: center;
  ...
  <div id="app">
    ...
    <div class="row">
      <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
        ...
        <img src="{{asset('public/img/background/rpr_logo.png')}}" alt="logo" width="100" class=" rounded-circle">
