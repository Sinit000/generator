...
<div class="main-content">
    ...
    <section class="section">
        ...
        <div class="section-header">
            <h1 data="company" id="title-family" class="en"></h1>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btn-save').click(function() {
            ...
            var type = "POST";
            var ajaxurl = "{{url('admin/company/store')}}";
            ...
            if (state == "update") {
                ...
                var id = $('#id').val();
                type = "POST";
                ajaxurl = "{{ url('admin/company/update') }}" + '/' + id;
                console.log(ajaxurl);
            }
        ...
        $(document).on('click', '#editBtn', function() {
            ...
            console.log(id);
            $.get("{{ url('admin/company/edit') }}" + '/' + id, function(data) {
                $('#company-form').find('.form-control').removeClass('is-invalid is-valid');
                $('#id').val(data.data.id);
