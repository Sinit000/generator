...
<style>
    ...
    .kh[data="allowance"]::before {
        content: 'ប្រាក់ឧបត្ថម្ភ'
    }
    .en[data="allowance"]::before {
        content: 'Allowance'
...
<div class="main-content">
    <section class="section">
         <div class="section-header">
            <h1 data="structure" id="title-family" class="en"></h1>
            <div class="section-header-breadcrumb">
               <div class="breadcrumb-item" >
                    <i class="fa fa-home" ></i>
                    <a href="{{ url('admin/dashboard') }}" data="dashboard" id="subtitle-family" class="en" >
                        ...
                        <table class="table table-sm table-hover" id="user-table">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th ><p class="en" data="allowance" id="subtitle-family"></p>  </th>
