...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1 data="contract" id="title-family" class="en"></h1>
                        ...
                        <table class="table table-sm table-hover" id="user-table">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th><p class="en" data="ref_code" id="subtitle-family"></p></th>
                                    <th><p class="en" data="user_name" id="subtitle-family"></p> </th>
                                    <th><p class="en" data="structure" id="subtitle-family"></p> </th>
                                    <th><p class="en" data="start_date" id="subtitle-family"></p> </th>
                                    <th><p class="en" data="end_date" id="subtitle-family"></p> </th>
                                    <th><p class="en" data="working" id="subtitle-family"></p></th>
                                    <th><p class="en" data="base_salary" id="subtitle-family"></p></th>
