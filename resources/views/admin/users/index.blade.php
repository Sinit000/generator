...
<style>
    .en[data="terminal_id"]::before {
        content: 'Terminal ID'

    }

    .kh[data="terminal_id"]::before {
        content: 'លេខមាស៊ីនID'
    }
    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card card-info">
                @if(auth()->user()->role->name === "Owner" || auth()->user()->role->name === "Super Admin")
                        ...
                        <table class="table table-sm table-hover table-bordered" id="user-table">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th>
                                        <p class="en" data="terminal_id" id="subtitle-family"></p>
                                    </th>
                                    <th>
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        if(response.role_name=="Super Admin"){
                            ...
                            time += "<option value='" + response.user.id + "'>" + response.user.name + "</option>";
                        }
