            ...
            <div class="card card-info">
                <div class="card-header">
                    <div class="ml-auto">
                        ...
                        <button class="btn btn-danger ml-auto" id="btn-add">
                            <i class="fas fa-plus-circle"></i>
                            <a href="{{ url('admin/report/attendances') }}">Attendance</a>
                        </button>
...
<script type="text/javascript" src="{{ asset('public/backend/js/bootstrap-datepicker.min.js') }}"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function getData(startDate, endDate, userId) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ url('admin/report/attendances') }}" + '/' + userId + '/' + startDate + '/' + endDate + '/' + "false",
                dataType: 'json',
                beforeSend: function() {
                        ...
                        data.data.forEach((item, index) => {
                            ...
                            var element = `<tbody>
                                <tr>
                                    ...
                                    <td  class="text-center">${item.attendance_status}</td>
                                    <td class="text-center">${item.checkin_time}</td>
                                    <td class="text-center">${item.checkout_time}</td>
                                    <td class="text-center">${item.attendance_worked}</td>
        ...
        $('#btn_export').on('click', function() {
            ...
            var url = "{{URL::to('admin/report/attendances')}}"+ '/' + userId  + '/' + fromDate + '/' + toDate + '/' + "true";
            console.log(url);
